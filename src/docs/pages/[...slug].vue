...
<template>
  <main>
    ...
    <div class="container mx-auto mt-6 flex flex-row space-x-8 px-28 pt-20">
      <div
        class="sticky top-24 h-[calc(100vh-theme(spacing.16))] w-1/6 overflow-y-auto"
      >
        <ul>
      ...
      <div class="w-4/6 px-6">
        <div
          class="prose max-w-full dark:prose-invert prose-a:no-underline prose-thead:bg-gray-3 prose-th:px-3 prose-th:py-2 prose-td:px-3 prose-td:py-2 prose-thead:rounded-t-lg prose-headings:scroll-mt-24"
        >
          <ContentDoc>
            <template #not-found>
