...
<template>
  <div class="not-prose">
    ...
    <template v-else-if="radioBasic">
      <div class="tabs">
        <input
          type="radio"
          id="tab-1"
          name="tab-1"
          class="tab-toggle tab"
          checked
        />
    ...
    <template v-else-if="radioBordered">
      <div class="tabs">
        <input
          type="radio"
          id="tab-4"
    ...
    <template v-else-if="radioUnderline">
